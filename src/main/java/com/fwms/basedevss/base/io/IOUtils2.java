...
public class IOUtils2 {
    ...
    public static byte[] toBytes(com.fwms.basedevss.base.io.Serializable o) {
        Validate.notNull(o);
    ...
    public static <T extends com.fwms.basedevss.base.io.Serializable> T fromBytes(Class<T> type, byte[] bytes, int off, int len) {
    ...
    public static <T extends com.fwms.basedevss.base.io.Serializable> T fromBytes(Class<T> type, byte[] bytes) {
        return fromBytes(type, bytes, 0, bytes.length);
    }

    public static ByteBuffer toByteBuffer(com.fwms.basedevss.base.io.Serializable o) {
        return ByteBuffer.wrap(toBytes(o));
    }


    public static <T extends com.fwms.basedevss.base.io.Serializable> T fromByteBuffer(Class<T> type, ByteBuffer byteBuff, int off, int len) {
    ...
    public static <T extends com.fwms.basedevss.base.io.Serializable> T fromByteBuffer(Class<T> type, ByteBuffer byteBuff) {
